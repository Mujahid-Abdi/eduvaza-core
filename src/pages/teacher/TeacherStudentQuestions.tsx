...
export const TeacherStudentQuestions = () => {
  const { t } = useI18n();
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        >
          ...
          <p className="text-muted-foreground">View and respond to student questions about your courses and quizzes</p>
        </motion.div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Your answer will be sent to {selectedQuestion.studentName} via notification
                  </p>
                </div>
              </div>
            )}
...
export default TeacherStudentQuestions;
